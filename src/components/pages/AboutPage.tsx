...
export function AboutPage({ onNavigate }: AboutPageProps) {
  return (
    <div className="container mx-auto px-4 py-12 space-y-16">
      ...
      <section className="space-y-10"><Card><CardHeader><CardTitle className="flex items-center space-x-2"><Mail className="h-6 w-6 text-secondary" /><span>Contact Us</span></CardTitle></CardHeader><CardContent className="space-y-6"><p className="text-muted-foreground">We'd love to hear from you. Whether you have questions, feedback, or ideas for collaboration, don't hesitate to reach out.</p><div className="grid md:grid-cols-2 gap-4"><div className="space-y-3"><h5 className="font-medium">General Enquiries</h5><a href="mailto:henriquegullo@themanereview.com" className="flex items-center gap-2 p-3 border rounded-lg hover:bg-muted/50 transition-colors"><Mail className="h-4 w-4 text-muted-foreground" /><span className="text-sm">henriquegullo@themanereview.com</span></a></div><div className="space-y-3"><h5 className="font-medium">Article Submissions & Joining Our Team</h5><a href="mailto:henriquegullo@themanereview.com" className="flex items-center gap-2 p-3 border rounded-lg hover:bg-muted/50 transition-colors"><Mail className="h-4 w-4 text-muted-foreground" /><span className="text-sm">henriquegullo@themanereview.com</span></a><p className="text-xs text-muted-foreground">Contact us to submit articles or join The Mane Review</p></div></div></CardContent></Card></section>
    </div>
  );
}